...
export const episodes = [
  ...
  },
  {
    ...
    tags: ["Parent", "With Kids", "A1 to C1"],
  ...
  },
  {
    ...
    description:
      "This episode features an incredible success story of someone who achieved fluency in Finnish in just one year. Learn about the intensive study methods, daily routines, and mindset shifts that made this rapid progress possible. The guest shares practical strategies for maximizing language learning efficiency, including specific techniques for vocabulary acquisition, grammar mastery, and speaking confidence. Whether you're just starting your Finnish journey or looking to accelerate your progress, this episode provides valuable insights and motivation.",
    tags: ["Student", "A1 to C1", "Immersion method"],
